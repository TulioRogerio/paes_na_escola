  ...
  const gruposQuestoes = [
    {
      ...
      questoes: [
        ...
        {
          id: "pec2",
          texto: "Quantos professores participam do PEC?",
          tipo: "texto_curto",
        },
        {
          id: "pec3",
          texto: "Qual a frequência das reuniões do PEC?",
          tipo: "multipla_escolha",
          opcoes: ["Semanal", "Quinzenal", "Mensal", "Não há reuniões"],
        },
      ],
    },
    {
      ...
      questoes: [
        {
          id: "mat1",
          texto: "A escola recebe material didático complementar?",
          tipo: "sim_nao",
        },
        {
          id: "mat2",
          texto: "O material está sendo utilizado pelos professores?",
          tipo: "sim_nao",
        },
        {
          id: "mat3",
          texto: "Descreva como o material está sendo utilizado:",
          tipo: "texto_longo",
        },
      ],
    },
    {
      ...
      questoes: [
        {
          id: "for1",
          texto: "Os professores participam de formações continuadas?",
          tipo: "sim_nao",
        },
        {
          id: "for2",
          texto: "Quantas formações foram realizadas neste trimestre?",
          tipo: "texto_curto",
        },
        {
          id: "for3",
          texto: "Quais áreas foram abordadas nas formações?",
          tipo: "texto_longo",
        },
      ],
    },
    {
      ...
      questoes: [
        {
          id: "rot1",
          texto: "A escola possui rotinas pedagógicas definidas?",
          tipo: "sim_nao",
        },
        {
          id: "rot2",
          texto: "As rotinas estão sendo seguidas?",
          tipo: "sim_nao",
        },
        {
          id: "rot3",
          texto: "Descreva as principais rotinas pedagógicas:",
          tipo: "texto_longo",
        },
      ],
    },
    {
      ...
      questoes: [
        {
          id: "ges1",
          texto: "A gestão utiliza dados para tomada de decisão?",
          tipo: "sim_nao",
        },
        {
          id: "ges2",
          texto: "Quais estratégias estão sendo implementadas?",
          tipo: "texto_longo",
        },
        {
          id: "ges3",
          texto: "Como os dados são coletados e analisados?",
          tipo: "texto_longo",
        },
      ],
    },
    {
      ...
      questoes: [
        ...
        {
          id: "pre2",
          texto: "Quais ações foram desenvolvidas?",
          tipo: "texto_longo",
        },
        {
          id: "pre3",
          texto: "Qual o resultado alcançado?",
          tipo: "texto_curto",
        },
      ],
    },
          ...
          <div className="questao-sim-nao">
            <label className="radio-option">
              <input
                ...
                onChange={(e) =>
                  handleRespostaChange(questao.id, e.target.value)
                }
              />
              <span>Sim</span>
            </label>
  ...
  return (
    <div className="formulario-visita">
      ...
      <div className="filtros-container">
        <div
          className={`filtros-card ${filtrosAbertos ? "aberto" : "fechado"}`}
        >
          <div className="filtros-header">
            ...
            >
              ...
              <span className={`chevron ${filtrosAbertos ? "aberto" : ""}`}>
                ▲
              </span>
            </button>
          </div>
                  ...
                  <div className="select-wrapper">
                    <div className="select-tags">
                      ...
                      >
                        ...
                        {SRES.filter((sre) => sre !== filtros.sre).map(
                          (sre) => (
              ...
              <div className="tab-panel">
                <div className="card questao-geral">
                  ...
                  <div className="form-group">
                    <label htmlFor="escolaPrioritaria">
              ...
              <div className="tab-panel">
                <div className="card grupo-questoes">
                  ...
                  <p className="fotos-description">
                    Adicione fotos da visita técnica aqui.
                  </p>
